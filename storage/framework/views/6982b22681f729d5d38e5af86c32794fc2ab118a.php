          ...
          <div class="postcontent col-lg-9 order-lg-last">
            <div id="shop"class="shop row grid-container gutter-20" data-layout="fitRows">
              <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <div class="product col-md-4 col-sm-6 col-6 <?php echo e($item->taxonomy_alias ?? $item->taxonomy_title); ?>">
                  <div class="product-image">
                    ...
                    <div class="bg-overlay">
                      ...
                      >
                      <a href="javascript:void(0)" title="<?php echo app('translator')->get('Add to cart'); ?>" style="border: 0px" data-id="<?php echo e($item->id); ?>" data-quantity="1" class="add-to-cart btn me-2 text-white bg-success "
