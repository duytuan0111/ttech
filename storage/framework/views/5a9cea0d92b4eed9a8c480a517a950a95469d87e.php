                                                                                                    ...
                                                                                                    <?php $__currentLoopData = $taxonomy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                        <?php if($item->parent_id == $row->id): ?>
                                                                                                            <li>
                                                                                                                ...
                                                                                                                <ul>
                                                                                                                    <?php $__currentLoopData = $taxonomy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                                        <?php if($it->parent_id == $item->id): ?>
                                                                                                                            <li>
                                                                                                                                <label
                                                                                                                                    for="menu_chill_<?php echo e($it->id); ?>">
                                                                                                                                    <input
                                                                                                                                        id="menu_chill_<?php echo e($it->id); ?>"
                                                                                                                                        name="menu_taxonomy[]"
                                                                                                                                        type="checkbox"
                                                                                                                                        value="<?php echo e($it->id); ?>">
                                                                                                                                    <?php echo e($it->title); ?>
                                                                                    ...
                                                                                    <div class="form-control">
                                                                                        <label
                                                                                            ...
                                                                                            <input type="checkbox"
                                                                                                ...
                                                                                                value="normal"
                                                                                                <?php echo e((isset($item->json_params->style) && $item->json_params->style == 'normal') ? 'checked' : ''); ?>>
                                                                                            <small
                                                                                                class="mr-15">Normal</small>
                                                                                        </label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ttech\resources\views/admin/pages/menus/edit.blade.php ENDPATH**/ ?>