                        ...
                        if (response.message == 'success') {
                            ...
                            if (list.length > 0) {
                                list.forEach(item => {
                                    ...
                                    _item +=
                                        '<input name="json_params[block_content][]" type="checkbox" value="' +
                                        item.id +
                                        '" class="mr-15 block_item cursor" id="block_content_' +
                                        item.id + '">';
                                    _item +=
                                        '<label class="cursor" for="block_content_' +
                                        item.id + '">';
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/tuannguyenduy/Sites/ttech/ttech/resources/views/admin/pages/pages/edit.blade.php ENDPATH**/ ?>