            ...
            <table class="table table-hover table-bordered">
              ...
              <tbody>
                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php
                    $url_mapping = App\Helpers::generateRoute(App\Consts::TAXONOMY['product'], $row->post_title, $row->item_id, 'detail', $row->taxonomy_title);
                  ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ttech\resources\views/admin/pages/orders/order_product_show.blade.php ENDPATH**/ ?>