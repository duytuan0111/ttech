                ...
                <div class="row">
                      ...
                      <div class="row">
                        <div class="col-xs-6">
                          ...
                          <input type="text" class="form-control" name="json_params[price]"
                            placeholder="<?php echo app('translator')->get('Price'); ?>" value="<?php echo e(old('json_params[price]')); ?>">
                        </div>
                        <div class="col-xs-6">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="json_params[brief][vi]" class="form-control" id="brief_vi" rows="2"><?php echo e(old('json_params[brief][vi]')); ?></textarea>
                    </div>
                  </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ttech\resources\views/admin/pages/cms_products/create.blade.php ENDPATH**/ ?>