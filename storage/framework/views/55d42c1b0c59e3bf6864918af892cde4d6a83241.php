...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" onsubmit=" return check_nestb()" action="<?php echo e(route(Request::segment(2) . '.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="box-body">
                    <!-- Custom Tabs -->
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/tuannguyenduy/Sites/ttech/ttech/resources/views/admin/pages/pages/create.blade.php ENDPATH**/ ?>