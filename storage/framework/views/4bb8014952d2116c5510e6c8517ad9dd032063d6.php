              ...
              <select name="parent_id" id="parent_id" class="form-control select2">
                ...
                <?php $__currentLoopData = $rootMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($item->parent_id == 0 || $item->parent_id == null): ?>
                    ...
                    <?php $__currentLoopData = $rootMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($item->id == $sub->parent_id): ?>
                        <option value="<?php echo e($sub->id); ?>" <?php echo e($adminMenu->parent_id == $sub->id ? 'selected' : ''); ?>>
                          - -
                          <?php echo e($sub->name); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ttech\resources\views/admin/pages/admin_menus/edit.blade.php ENDPATH**/ ?>